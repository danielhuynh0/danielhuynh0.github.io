...
const Projects = React.forwardRef((props, ref) => {
    const projects = [
        ...
        },
        {
          ...
          images: ['smb.png'],
          description: "Allows a user to enter and search for a stock ticker. The bot will load a description of the stock itself, as well as a graph of the stock's price history. It will also utilize natural language processing on live news sites to determine the sentiment of the news articles on the stock, as well as ML models on the stock's price history, to determine whether to recommend the user to buy, sell, or hold the stock at this current time.",
          tools: "Frontend implemented with React. Python used for backend, with Flask. Web scraping done with Beautiful Soup. NLP utilizes NLTK library. Store login data in Firebase (in the process of being implemented)."
        },
        {
