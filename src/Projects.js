...
const Projects = React.forwardRef((props, ref) => {
    const projects = [
        ...
        },
        {
          ...
          tools: "Built with Spotify API, with UI built purely with JavaScript, HTML, CSS, generated icons from GPT, and on Google Chrome Developer Mode. I learned PCKE for sending requests to Spotify.",
